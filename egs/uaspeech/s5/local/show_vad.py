...
Shows the VAD result from a vad ark file produced by Kaldi's compute-vad.

e.g. compute-vad --config=conf/vad.conf scp:results/data/mfcc_data_full/feats.scp ark,t:vad.ark
"""
